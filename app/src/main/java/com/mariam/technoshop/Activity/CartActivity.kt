...
fun CartSummary(itemTotal: Double, tax: Double, delivery: Double) {
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = "Totale des articles:",
                Modifier.weight(1f),
                fontWeight = FontWeight.Bold,
                color = colorResource(R.color.grey)
            )
            Text(text = "DH$itemTotal")
        }
        Row(
            modifier = Modifier
                .fillMaxWidth()
...
fun CartItem(
    ...
    ConstraintLayout(
        ...
        Text(text = "DH${item.price}", color = colorResource(R.color.purple),
            modifier = Modifier
        ...
        Text(
            text = "DH${item.numberInCart * item.price}",
            fontSize = 18.sp,
